...
console.log("Exercise 1: " + sayHello("Ben"))
...
console.log("Exercise 2b: " + helloMessage);
...
console.log("Exercise 3: " + helloMessage);
...
let x = parseFloat(prompt("What percentage tip would you like to give?"));
x /= 100;
